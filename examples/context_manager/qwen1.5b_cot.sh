...
python3 -m examples.context_manager.train_cm \
    ...
    trainer.experiment_name='cm-lcb-qwen1.5-coder-4k' \
...
#     algorithm.mask_truncated_samples=True \
#     algorithm.clip_advantages=False \
#     algorithm.grpo.group_by_position=True \
#     algorithm.grpo.non_cumulative=True \
#     algorithm.grpo.broadcast_advantage=False \
#     trainer.critic_warmup=0 \
#     trainer.logger=['wandb','console'] \
#     trainer.project_name='rllm-deepcoder' \
#     trainer.experiment_name='cm-lcb-qwen1.5-coder-4k' \
