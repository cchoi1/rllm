...
#SBATCH --job-name="eval_cm_ours_2turn_step25_sol_base"
#SBATCH --output=cm_ours_2turn_step25_sol_base.log
...
MODEL_PATH="/nlp/scr/cchoi1/rllm/checkpoints/rllm-deepcoder/cm-deepcoder1.5b-broadcast-2steps-new/global_step_25/actor/checkpoint"
