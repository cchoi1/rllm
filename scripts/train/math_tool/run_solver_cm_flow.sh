...
#SBATCH --job-name="math_tool_solver_cm_flow"
#SBATCH --output=math_tool_solver_cm_flow.log
...
# Run the solver CM flow evaluation (make Python unbuffered so prints hit the .log immediately)
echo "Starting solver CM flow evaluation..."
PYTHONUNBUFFERED=1 python3 -u examples/math_tool/run_solver_cm_flow.py
