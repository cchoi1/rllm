...
#SBATCH --job-name="deepcoder_1.5b_cm_mc_4_steps_code_penalty"
#SBATCH --output=deepcoder_1.5b_cm_mc_4_steps_code_penalty.log
...
RUN_NAME="cm-deepcoder1.5b-mc-4steps-fp16-exclude-code"
...
VLLM_HOST="jagupard33.stanford.edu"
VLLM_PORT=12345
...
python3 -m examples.context_manager.train_cm \
    ...
    ++rllm.env.env_args.reward_kwargs.exclude_code=True \
