...
#SBATCH --job-name="cm_cot_mc_small"
#SBATCH --output=cm_cot_mc_small.log
...
srun --ntasks=1 --gpus-per-task=${NUM_GPUS} --exclusive -c 100 --mem=672GB \
  --output="./cm_cot_mc_small.log" --error="./cm_cot_mc_small.log" \
