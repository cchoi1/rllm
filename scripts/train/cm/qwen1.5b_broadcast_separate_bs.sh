...
#SBATCH --job-name="cm_broadcast_small_4_steps_bs"
#SBATCH --output=cm_broadcast_small_4_steps_bs.log
...
python3 -m examples.context_manager.train_cm \
    ...
    trainer.experiment_name="cm-qwen1.5b-coder-broadcast-4k-4steps-bs" \
