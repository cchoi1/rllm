...
#SBATCH --job-name="deepcoder_1.5b_cm_mc_4_steps_float16_11-2"
#SBATCH --output=deepcoder_1.5b_cm_mc_4_steps_float16_11-2.log
...
RUN_NAME="cm-deepcoder1.5b-mc-4steps-fp16-11-2"
RUN_DIR="/nlp/scr/cchoi1/rllm/runs/$RUN_NAME"
# RUN_DIR=/scr/biggest/cchoi1/rllm/runs/$RUN_NAME
# mkdir -p "$RUN_DIR"
...
# export WANDB_RUN_ID="g76bjz0l"   # the run that currently has steps 0..18
# export WANDB_REWIND_STEP="40"    # keep 0..10, drop 11..18
...
python3 -m examples.context_manager.train_cm \
    ...
    ++trainer.resume_from_path="/nlp/scr/cchoi1/rllm/checkpoints/rllm-deepcoder/cm-deepcoder1.5b-mc-4steps-fp16-11-2/global_step_50" \
