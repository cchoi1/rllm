...
VLLM_HOST="jagupard38.stanford.edu"    # e.g., sphinx8.stanford.edu or 10.24.7.52
VLLM_PORT=12345
...
# GPU Configuration
# Total GPUs needed: NUM_GPUS (training) + reward_manager.world_size (reward manager)
# Current: 4 (training) + 1 (reward manager) = 5 GPUs total
# If you have 8 GPUs available, you can set:
#   NUM_GPUS=6
#   +reward_manager.world_size=2
# If you only have 4 GPUs, keep current settings:
NUM_GPUS=4
...
python3 -m examples.context_manager.train_cm \
    ...
    ++trainer.resume_from_path=/nlp/scr/cchoi1/rllm/checkpoints/rllm-deepcoder/cm-qwen1.5b-coder-mc-4k-2steps/global_step_30 \
    ...
    actor_rollout_ref.actor.ppo_max_token_len_per_gpu=10200 \
    ...
    trainer.experiment_name="cm-qwen1.5b-coder-mc-4k-4steps" \
    ...
    +env_args.solver_remote.temperature=0.6 \
    +env_args.solver_remote.max_tokens=4096