...
#SBATCH --job-name="deepcoder_1.5b_cm_broadcast_memory_4_steps_train_on_test"
#SBATCH --output=deepcoder_1.5b_cm_broadcast_memory_4_steps_train_on_test.log
...
RUN_NAME="cm-deepcoder1.5b-broadcast-memory-4steps-fp16-train-on-test"
...
NUM_GPUS=4
    ...
    # ++trainer.resume_from_path="/nlp/scr/cchoi1/rllm/checkpoints/rllm-deepcoder/cm-deepcoder1.5b-broadcast-memory-4steps-fp16/global_step_14" \
...
python3 -m examples.context_manager.debug_train_cm \
    ...
    ++rllm.agent.agent_args.use_memory=True \
    ...
    ++trainer.resume_mode=resume_path \
    ++trainer.resume_from_path="/nlp/scr/cchoi1/rllm/checkpoints/rllm-deepcoder/cm-deepcoder1.5b-broadcast-memory-4steps-fp16-train-on-test/global_step_10" \
    ...
    ++rllm.env.env_args.reward_kwargs.remote_api_key="${VLLM_API_KEY}" \
