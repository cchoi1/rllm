...
#SBATCH --job-name="cm_broadcast_small_2_steps_tiger"
#SBATCH --output=cm_broadcast_small_2_steps_tiger.log
...
python3 -m examples.context_manager.train_cm \
    ...
    trainer.experiment_name="cm-qwen1.5b-coder-broadcast-4k-2steps-tiger" \
