...
SGLANG_HOST="tiger7.stanford.edu"    # e.g., sphinx8.stanford.edu or 10.24.7.52
SGLANG_PORT=12345
...
python3 -m examples.context_manager.train_cm \
    ...
    +rllm.env.env_args.solver_remote.temperature=0.2 \
    +rllm.env.env_args.solver_remote.max_tokens=16384 \
    +rllm.env.env_args.solver_remote.base_url="$SGLANG_BASE_URL" \
    +rllm.env.env_args.solver_remote.model="$MODEL_PATH" \
    +rllm.env.env_args.reward_kwargs.remote_url="$SGLANG_BASE_URL" \
