...
export RAY_TMPDIR="/scr/biggest/$USER/ray_${SLURM_JOB_ID:-$$}"
export TMPDIR="/scr/biggest/$USER/tmp_${SLURM_JOB_ID:-$$}"
...
VLLM_HOST="tiger8.stanford.edu"    # e.g., sphinx8.stanford.edu or 10.24.7.52
VLLM_PORT=12345
...
python3 -m examples.context_manager.train_cm \
    ...
    trainer.experiment_name="cm-qwen1.5b-coder-broadcast-4k-2steps" \
