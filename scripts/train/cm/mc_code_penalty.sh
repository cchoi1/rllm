...
#SBATCH --job-name="cm_mc_4steps_code_penalty_real"
#SBATCH --output=cm_mc_4steps_code_penalty_real.log
...
RUN_NAME="cm-deepcoder1.5b-mc-4steps-fp16-code-penalty"
...
python3 -m examples.context_manager.train_cm \
    ...
    ++rllm.env.env_args.reward_kwargs.penalize_code_in_feedback=True \
    ++rllm.env.env_args.reward_kwargs.code_penalty=-1.0 \
