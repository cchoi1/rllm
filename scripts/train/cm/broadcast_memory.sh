...
#SBATCH --job-name="deepcoder_1.5b_cm_broadcast_memory_4_steps_float16_debug"
#SBATCH --output=deepcoder_1.5b_cm_broadcast_memory_4_steps_float16_debug.log
...
RUN_NAME="cm-deepcoder1.5b-broadcast-memory-4steps-fp16-debug"
