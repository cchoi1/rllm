...
#SBATCH --job-name="countdown_judge"
#SBATCH --output=countdown_judge.log
...
python3 -m examples.solver_judge.train_judge_flow \
    ...
    trainer.experiment_name='countdown-judge' \
