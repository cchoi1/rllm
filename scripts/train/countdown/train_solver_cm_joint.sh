...
#SBATCH --job-name="countdown_solver_cm_joint"
#SBATCH --output=countdown_solver_cm_joint.log
...
python3 -m examples.countdown.train_solver_cm_joint \
    ...
    trainer.experiment_name='countdown-solver-cm-joint' \
