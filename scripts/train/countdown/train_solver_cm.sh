...
#SBATCH --job-name="countdown_solver_cm"
#SBATCH --output=countdown_solver_cm.log
...
python3 -m examples.solver_judge.train_solver_cm_flow \
    ...
    trainer.experiment_name='countdown-solver-cm' \
