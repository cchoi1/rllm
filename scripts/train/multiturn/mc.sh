...
#SBATCH --job-name="mc_multiturn_sphinx"
#SBATCH --output=mc_multiturn_sphinx.log
...
export RUN_DIR="/scr/biggest/cchoi1/rllm/runs/multiturn-mc"
mkdir -p "$RUN_DIR"
export RUN_NAME="multiturn-deepcoder1.5b-mc-4steps-v2"
...
NUM_GPUS=4
    ...
    # ++trainer.resume_from_path="/nlp/scr/cchoi1/rllm/checkpoints/rllm-deepcoder/multi-deepcoder1.5b-broadcast-4steps-v2/global_step_30" \
...
python3 -m examples.deepcoder.train_deepcoder_multiturn \
    ...
    ++trainer.resume_mode=resume_path \
    ++trainer.resume_from_path="/nlp/scr/cchoi1/rllm/checkpoints/rllm-deepcoder/multiturn-deepcoder1.5b-mc-4steps-v2/global_step_10" \
