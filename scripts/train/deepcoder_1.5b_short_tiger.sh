...
#SBATCH --job-name="deepcoder_1.5b_short_tiger"
#SBATCH --output=deepcoder_1.5b_short_tiger.log
...
python3 -m examples.deepcoder.train_deepcoder \
    ...
    ++trainer.resume_from_path=/nlp/scr/cchoi1/rllm/checkpoints/rllm-deepcoder/deepcoder-1.5b-short/global_step_95 \
    ...
    actor_rollout_ref.actor.ppo_max_token_len_per_gpu=9048 \
