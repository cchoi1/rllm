...
#SBATCH --job-name="deepcoder_1.5b_broadcast_multiturn_bs32"
#SBATCH --output=deepcoder_1.5b_broadcast_multiturn_bs32.log
...
python3 -m examples.deepcoder.train_deepcoder_multiturn \
    ...
    trainer.experiment_name="multi-deepcoder1.5b-broadcast-4steps-marlowe-bs32" \
