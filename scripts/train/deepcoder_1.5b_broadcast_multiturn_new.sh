...
#SBATCH --job-name="deepcoder_1.5b_broadcast_multiturn_new"
#SBATCH --output=deepcoder_1.5b_broadcast_multiturn_new.log
...
python3 -m examples.deepcoder.train_deepcoder_multiturn \
    ...
    trainer.experiment_name="multi-deepcoder1.5b-broadcast-4steps" \
